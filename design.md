...
Various IFTA-style routines are to be implemented.

Building blocks:

- forward & backward transform
- routines that enforce constraints "here" and "there"
...
- tiny wrapper around imshow(): plot_image(I, x, y) with suitable extent,
  axis labelling... DONE
...
- proximity printing mask optimization
- WPM propagtion through a lens system: maybe a beam expander (Keplerian type)
